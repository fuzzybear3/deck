...
const STICKS_X: f32 = 525.;
const STICKS_Y: f32 = -285.;
    ...
    App::new()
        .add_plugins(DefaultPlugins.set(WindowPlugin {
            primary_window: Some(Window {
                ...
                // Optional: make it borderless and fullscreen
                // mode: bevy::window::WindowMode::BorderlessFullscreen,
                title: "Steam Deck App".to_string(),
                ..default()
            }),
            ..default()
        }))
        .add_plugins(VideoStreamer)
